...
public class SingleMultipleCheckAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context context;
    ArrayList<String> data;
    int type;

    public SingleMultipleCheckAdapter(Context context, ArrayList<String> data, int type) {
